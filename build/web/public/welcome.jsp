    ...
    <div id="login-form">
        ...
        <fieldset>
            <table style="border: none">
                <tr style="border: none">
                    ...
                    <td style="border: none">
                        ...
                        <html:text name="Usuario" property="nombreusuario" size="14" value="" errorStyleClass="error" errorKey="org.apache.struts.action.ERROR"/>
                    </td>
                </tr>
                <tr style="border: none">
            ...
            <div  style="position: relative; height: 120px; bottom: -10px;">
                ...
                <br>
                <br>
            <input type="submit" id="botonLogin" value="Login">  <br>    
