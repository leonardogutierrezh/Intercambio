...
<html:form action="/ModificarPerfil" acceptCharset="ISO-8859-1" onsubmit="return(this)">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="mail"><html:text name="Usuario" property="email" errorStyleClass="error"
                           errorKey="org.apache.struts.action.ERROR"></html:text>
                           <a id="enlace" href="#Foo" onclick="Marcar('.mail')">editar...</a>
               </td>
            </tr>
            <tr>
                <td colspan="2" style="color:firebrick">
            ...
            <tr>
                ...
                <td class="nom"><html:text name="Usuario" property="nombre" maxlength="100" errorStyleClass="error"
                           errorKey="org.apache.struts.action.ERROR"></html:text>
                           <a id="enlace" href="#Foo" onclick="Marcar('.nom')">editar...</a>
               </td>
            </tr>
            <tr>
                <td colspan="2" style="color:firebrick">
            ...
            <tr>
                <td>
                    <div>
                        <input type="checkbox" onclick="Marcar('.contra')" />Cambiar la contraseña
                        <!-- <a id="enlace" href="#Foo" onclick="Marcar('.contra')">Cambiar la contraseña.</a> -->
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <p style="text-align: center">
        <input type="submit" id="botonRecuperarpw" value="Modificar Usuario"
